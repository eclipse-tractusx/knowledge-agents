...
$ helm install my-release eclipse-tractusx/remoting-agent --version 1.9.6-SNAPSHOT
```
...
| resources | object | `{"limits":{"cpu":"500m","memory":"768Mi"},"requests":{"cpu":"250m","memory":"768Mi"}}` | [Resource management](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) applied to the deployed pod We recommend 25% of a cpu, 512MB per server and 256MB per endpoint  |
