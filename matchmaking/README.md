...
The [standalone jar](target/matchmaking-agent-1.10.15-SNAPSHOT.jar) may be started as follows

```console
java -Dproperty.file.location="dataplane.properties" -cp  ../matchmaking-agent-1.10.15-SNAPSHOT.jar org.eclipse.tractusx.agents.conforming.Bootstrap 
```
