...
The [standalone jar](target/matchmaking-agent-1.12.19.jar) may be started as follows

```console
java -Dproperty.file.location="dataplane.properties" -cp  ../matchmaking-agent-1.12.19.jar org.eclipse.tractusx.agents.conforming.Bootstrap 
```
