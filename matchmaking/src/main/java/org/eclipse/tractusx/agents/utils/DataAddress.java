...
import static org.eclipse.tractusx.agents.utils.CoreConstants.EDC_NAMESPACE;
...
public class DataAddress {
    ...
    public static class Builder<DA extends DataAddress, B extends Builder<DA, B>> {
        ...
        public B property(String key, Object value) {
            ...
            switch (key) {
                case SIMPLE_TYPE: 
                    address.properties.put(EDC_DATA_ADDRESS_TYPE_PROPERTY, value);
                    break;
                case SIMPLE_KEY_NAME:
                    address.properties.put(EDC_DATA_ADDRESS_KEY_NAME, value);
                    break;
                default:
