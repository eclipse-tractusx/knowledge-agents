...
public class AgentConfig {
    ...
    public static final String MATCHMAKING_PORT_INTERNAL = "cx.agent.matchmaking.internal.api";
    ...
    public int getMatchmakingPortInternal() {
        return config.getInteger(MATCHMAKING_PORT_INTERNAL);
    }
