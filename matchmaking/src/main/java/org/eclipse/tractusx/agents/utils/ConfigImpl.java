...
public class ConfigImpl implements Config {
    ...
    private boolean parseBoolean(String value) {
        ...
        throw new MatchmakingException(format("Cannot parse %s to boolean", value));
    }
    ...
    private <T> T getParsed(String key, T defaultValue, String typeDescription, Function<String, T> parse) {
        ...
        if (value == null) {
            ...
            try {
                ...
                throw new MatchmakingException(format("Setting %s with value %s cannot be parsed to %s", absolutePathOf(key), value, typeDescription));
            }
        }
    }
    ...
    private <T> T getNotNullValue(String key, BiFunction<String, T, T> function) {
        ...
        if (value == null) {
            throw new MatchmakingException(format("No setting found for key %s", absolutePathOf(key)));
        } else {
            return value;
        }
    }
